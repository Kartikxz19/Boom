  ...
  return (
    ...
    <section className='flex size-full flex-col gap-10 text-white'>
      ...
      <div className="flex gap-5 ">
        ...
        <Button className='bg-blue-1 text-white hover:text-black' onClick={startRoom}>Start Meeting</Button>
        <Button className='bg-dark-1 text-white hover:text-black' onClick={()=>{
